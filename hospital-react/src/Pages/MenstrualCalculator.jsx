  ...
  return (
    <div className="bg-green-50 min-h-screen p-8">
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
        <h1 className="text-3xl font-bold text-green-800 mb-6 text-center">Menstrual Cycle Calculator</h1>
        
        <div className="mb-4">
          <label htmlFor="lastPeriodDate" className="block text-green-700 font-semibold mb-2">
        ...
        <div className="mb-6">
          <label htmlFor="cycleLength" className="block text-green-700 font-semibold mb-2">
        ...
        {nextPeriod && (
          <div className="mt-8 p-4 bg-pink-50 border border-pink-200 rounded-lg">
            ...
            <p className="mt-2 text-gray-700">
              Your next estimated period is: <strong className="text-green-600">{nextPeriod}</strong>
            </p>
            <p className="mt-2 text-gray-700">
              Your approximate ovulation day is: <strong className="text-green-600">{ovulationDate}</strong>
            </p>
