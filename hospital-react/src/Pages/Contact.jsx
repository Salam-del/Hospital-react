              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">123 MediCare Avenue</p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+1234567890" className="hover:text-green-600 transition-colors">+1 (234) 567-8900</a>
                    </p>
                    <p className="text-gray-600">
                      <a href="tel:+1234567891" className="hover:text-green-600 transition-colors">+1 (234) 567-8901</a> (Emergency)
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:info@medicare.com" className="hover:text-green-600 transition-colors">info@medicare.com</a>
                    </p>
                    <p className="text-gray-600">
                      <a href="mailto:support@medicare.com" className="hover:text-green-600 transition-colors">support@medicare.com</a>
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden">
              ...
              <div className="h-64">
                <iframe
                  ...
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3151.835434509374!2d144.9537363153169!3d-37.8162797797517!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6ad65d43f1f6e7b1%3A0x5045675218ce6e0!2sHospital!5e0!3m2!1sen!2sau!4v1614037068776!5m2!1sen!2sau"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen=""
